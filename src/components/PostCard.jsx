        ...
        <Card>
            <div className="flex gap-3">
                ...
                <div className="relative">
                    ...
                    {dropdownOpen && (
                        <div className="bg-red w-7 h-7 absolute top-0 cursor-pointer"></div>
                    )}
            ...
            <div>
                <p className="my-3 text-sm">Lorem Ipsum Lorem Ipsum Lorem IpsumLorem IpsumLorem Ipsum Lorem Ipsum Lorem IpsumLorem IpsumLorem IpsumLorem Ipsum Lorem Ipsum Lorem IpsumLorem Ipsum</p>
            ...
            <div className="flex mt-4 gap-3">
                ...
                <div className="border grow rounded-full relative">
                    <textarea className="block w-full px-4 p-3 overflow-hidden h-12 rounded-full" placeholder="Leave a comment" />
